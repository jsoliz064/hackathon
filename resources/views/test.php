...
$exif = exif_read_data("ee01bf82-f4cf-40df-8e05-21be38567cd2.jpg"); $lon = getGps($exif["GPSLongitude"], $exif['GPSLongitudeRef']); $lat = getGps($exif["GPSLatitude"], $exif['GPSLatitudeRef']); var_dump($lat, $lon);
